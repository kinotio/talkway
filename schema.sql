...
comment on table public.direct_messages is 'Individual messages sent between user.';
...
create policy "Allow individual update access" on public.direct_messages for update using ( auth.uid() = sender_id );
create policy "Allow individual delete access" on public.direct_messages for delete using ( auth.uid() = sender_id );
create policy "Allow authorized delete access" on public.direct_messages for delete using ( authorize('messages.delete', auth.uid()) );
